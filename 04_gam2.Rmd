...
[^imdb]: One might think this would be more interesting data, but there is actually not much variability in scores.  They have a mean of `r round(mean(imdb$imdb_score), 1)` and standard deviation, of `r round(sd(imdb$imdb_score), 1)`, with some skew (notable duds).
