...
The penalty regards the size of the coefficients for the smooth terms in our model.  The practical side is that it will help to keep us from overfitting the data, where our smooth function might get too wiggly[^wiggly].  For a little more detail visit the [technical section][Penalized regression].
