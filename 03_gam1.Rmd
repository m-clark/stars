...
Let's get things started by demonstrating the results from a GAM that uses a <span class="emph">polynomial spline</span> for the basis.  The brave may refer to the [technical details][Technical details] section.  Conceptually it is useful to continue to think of the piecewise approach we talked about before, however, we'll end up with a smoother and connected result when all is said and done.
