...
For the standard Gaussian setting, we can use our R^2^.  Also provided is 'deviance explained', which in this setting is identical to the unadjusted R^2^, but for non-Gaussian families might be preferred. 
